...
classifier3 = ClassifierModel(1,4)

#LSTMmodel = classifier1.BuildModelLSTM(3,25)
#ResNetLSTM1model = classifier1.BuildModelResNetLSTM1(25,0.2)
ResNetLSTM2model1 = classifier1.BuildModelResNetLSTM2(25,0.2)
ResNetLSTM2model2 = classifier2.BuildModelResNetLSTM2(25,0.2)
ResNetLSTM2model3 = classifier3.BuildModelResNetLSTM2(25,0.2)

###################
# Train the Model #
###################
print('Training the model')                     
#history = LSTMmodel.fit(dsbatch_train, dslabel_train, epochs=200, validation_split = 0.3)
#history = ResNetLSTM1model.fit(dsbatch_train, dslabel_train, epochs=200, validation_split = 0.3)
#history = ResNetLSTM2model.fit(dsbatch_train, dslabel_train, epochs=200, validation_split = 0.3)
history1 = classifier1.FitModel(ResNetLSTM2model1,dsbatch_train,dslabel_train,400,0.3)
history2 = classifier2.FitModel(ResNetLSTM2model2,dsbatch_train,dslabel_train,400,0.2)
history3 = classifier3.FitModel(ResNetLSTM2model3,dsbatch_train,dslabel_train,400,0.2)
...
plt.plot(history2.history['val_loss'],'g',label='validation_loss')
plt.legend()
plt.subplot(212)
plt.plot(history2.history['accuracy'],'b',label='training_accuracy')
plt.plot(history2.history['val_accuracy'],'g',label='validation_accuracy')
plt.legend()
history2.history.keys()

plt.figure()
plt.subplot(211)
plt.plot(history3.history['loss'],'b',label='training loss')
plt.plot(history3.history['val_loss'],'g',label='validation_loss')
plt.legend()
plt.subplot(212)
plt.plot(history3.history['accuracy'],'b',label='training_accuracy')
plt.plot(history3.history['val_accuracy'],'g',label='validation_accuracy')
plt.legend()
...
y_pred2 = ResNetLSTM2model1.predict(trajTestNorm)
